      ...
      UI : {
        Table : {
          init : function(context) {
            $('table.aldu-helpers-html-table', context)
                .autoload(
                    'jquery.datatables',
                    {
                      extras : [ 'tabletools' ]
                      ...
                      if ($(table).hasClass('aldu-core-view-index')) {
                            ...
                            .dataTable(
                                {
                                  ...
                                  fnDrawCallback : function(oSettings) {
                                    $('tbody tr td div[data-url].editable',
                                        this)
                                        .autoload(
                                            'jquery.jeditable',
                                            function(i, td) {
                                  ...
                                  fnServerParams : function(aoData) {
                                    ...
                                    for ( var i in oSettings.aoPreSearchCols) {
                                      if (oSettings.aoPreSearchCols[i].sSearch) {
                                        var attribute = $(
                                            oSettings.aoColumns[i].nTh).data(
                                            'name');
                                        aoData.push({
                                          name : 'sSearchCol_' + i,
                                          value : attribute
                        ...
                        $('thead th.searchable', table).not('.select').each(
                            function(i, th) {
                              ...
                              input.on('keyup.ui.aldu click.ui.aldu',
                                  function() {
                                    var input = this;
                                  ...
                                  fnDrawCallback : function(oSettings) {
                                    ...
                                    tagsTable.$('td:first-child input').on(
                                        ...
                                        function() {
                                          ...
                                          taggedTable.sortable('refresh')
                                              .trigger('sortupdate');
                                          // Since trigger('sortupdate') doesn't
                                          // work!
                                          $('tr input[name*="[weight]"]',
                                              taggedTable).each(function() {
                        ...
                        $('thead th.searchable.select', table).each(
                            function(i, th) {
                              ...
                              var option = $('<option>').text(
                                  Aldu.t('Filter') + ' ' + title);
                              select.append(option);
                              var aData = tagsTable.fnGetColumnData(index,
                                  true, true, true, true);
                        ...
                        $('tbody', table).sortable(
                            {
                              update : function(event, ui) {
                                $('tr input[name*="[weight]"]', event.target)
                                    .each(function() {
                                      var tr = $(this).closest('tr');
                                      var weight = tr.index();
                                      $(this).val(weight);
        ...
        Form : {
                ...
                .autoload(
                    ...
                    function(i, form) {
                      ...
                      $.tools.validator.fn('[data-equals]', Aldu
                          .t("Value not equal with the $1 field."), function(
                          input) {
                      ...
                      $(form.elements).filter('textarea[data-mode]')
                          .autoload(
                              'codemirror',
                              {
                                modes : [ 'php' ],
                                themes : [ 'eclipse', 'night', 'cobalt',
                                    'monokai' ]
                              }, function(i, textarea) {
                                $(textarea).codemirror({
          ...
          datetime : function(context) {
            $('input[type=date]', context).each(function(i, date) {
              ...
              clone.datepicker(options).datepicker('setDate', new Date(this.value.replace(/ /, 'T')));
            });
          }
        },
        Panel : {
